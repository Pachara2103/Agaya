...
import { processReturnService } from "../../../services/returnService"; 

export function AdminResponseForm({ disputeId, onProcessComplete }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await processReturnService(disputeId, status, responseMessage);
            alert(`Dispute ${disputeId} has been ${status}.`);
            onProcessComplete(); // Refresh the list
        } catch (err) {
