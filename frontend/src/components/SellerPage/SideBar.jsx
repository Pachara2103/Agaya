function SideBar({setPageSelected, pageSelected}) {
  return (
    <aside className="w-64 bg-gray-50 text-gray-600 p-6 flex-shrink-0">
      <nav className="space-y-9">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            <li>
              <a href="#สินค้าของฉัน" className={pageSelected=="สินค้าของฉัน"? 'text-[#b71f3b]':'hover:text-gray-900'} onClick={()=>setPageSelected("สินค้าของฉัน")}>
                สินค้าของฉัน
              </a>
            </li>
            <li>
