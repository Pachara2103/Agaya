  ...
  <div className="flex flex-col">
    ...
    <div className="flex items-center gap-4 mb-8">
      ...
      <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
          ...
          <span className="px-6 py-2 border-l border-r font-medium text-lg">{quantity}</span>
          <button
            onClick={increaseQuantity}
            className="px-4 py-2 text-xl font-bold text-red-500 hover:bg-gray-100 transition"
          >
            +
          </button>
      </div>
      ...
      <button 
          onClick={onBuyNow}
          className="px-8 py-3 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 transition shadow-md"
      >
          Buy Now
      </button>
