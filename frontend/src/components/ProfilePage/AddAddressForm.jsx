    ...
    return (
        <form onSubmit={handleSubmit} className="mt-6 border p-6 rounded-md">
            ...
            <div className="flex justify-end gap-4 mt-6">
                <button type="button" onClick={onCancel} className="!bg-gray-500 text-white py-2 px-6 rounded-md w-30 h-10 flex items-center justify-center cursor-pointer">
                    ยกเลิก
                </button>
                <button type="submit" className="!bg-teal-500 text-white py-2 px-6 rounded-md w-30 h-10 flex items-center justify-center cursor-pointer">
                    ยืนยัน
                </button>
            </div>
        </form>
